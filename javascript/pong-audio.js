...
export var wallSound = new soundFile("wallhit01.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("paddlehit01.mp3");
...
export var adventureMusic = new soundFile("straight.mp3");
